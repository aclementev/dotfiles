return {
    {
        ...
        keys = {
            ...
            {"<Leader>fn", function() Snacks.picker.files({ cwd = vim.fn.stdpath "config" }) end, desc = "Find files in Neovim config"},
            {"<Leader>fc", function() Snacks.picker.files({ cwd = vim.fn.joinpath(vim.fn.expand "~", "/dotfiles") }) end, desc = "Find files in Dotfiles"},
